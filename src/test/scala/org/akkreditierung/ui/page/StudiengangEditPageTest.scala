...
class StudiengangEditPageTest extends Specification with HSQLDbBefore {
  ...
  def setValue(form: FormTester, tuple: (String, String)) {
    form.setValue(tuple._1, tuple._2)
  }
...
//        .setValue("password", "wicket")
//        .submit()
//      val attribueMap = Map("Abschlussgrad"->"Bachelor of Science",
//        "Akkreditiert"->"Ja",
...
//      attribueMap.foreach(tuple=> setValue(form, tuple))
//      form.submit()
